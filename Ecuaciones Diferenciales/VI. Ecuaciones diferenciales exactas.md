...
---
Recordando de Calculo Vectorial, si tenemos la función de dos variables $z=f(x, y)$ entonces su diferencial está dado por la expresión
...
$$M(x, y)dx+N(x, y)dy=0$$
Podemos relacionar ambas ecuaciones mediante la siguiente igualdad
