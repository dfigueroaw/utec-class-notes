...
Las unidades de esta razón serán las mismas que las unidades de masa de la concentración y las unidades de tiempo del caudal. Si las unidades de volumen del caudal y la concentración no coinciden, tenemos que primero realizar la conversión de unidades apropiada. También es necesario asegurar que las unidades sean iguales en la razón de entrada y de salida para el cálculo de la diferencia
