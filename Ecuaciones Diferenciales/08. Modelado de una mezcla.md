...
Muchos de los ejercicios de mezclas nos van a pedir que nosotros mismos encontremos una expresión para $s_{out}(t)$. Sabemos que la concentración del componente en la mezcla saliente es la cantidad de masa del componente dividida por la cantidad de volumen que hay en la mezcla.

La cantidad de masa del componente en la mezcla es la función $A(t)$, pues así la definimos al comienzo. Respecto al volumen de la mezcla, sabemos que iniciamos con un volumen $V_0$, adem